...
contacts as (
    select distinct
        ...
        TO_NUMBER(c.custom_attributes:"monthly buildings and content insurance cost"::string) as monthly_buildings_and_content_insurance_cost,
        TO_NUMBER(c.custom_attributes:"Monthly Child Maintenance Payment"::string) as monthly_child_maintenance_payment,
        TO_NUMBER(c.custom_attributes:"monthly childcare costs"::string) as monthly_childcare_costs,
        TO_NUMBER(c.custom_attributes:"Monthly Clothing Cost"::string) as monthly_clothing_cost,
        TO_NUMBER(c.custom_attributes:"Monthly Council Tax Amount"::string) as monthly_council_tax_amount,
        TO_NUMBER(c.custom_attributes:"Monthly Electric Cost"::string) as monthly_electric_cost,
        TO_NUMBER(c.custom_attributes:"Monthly Energy Costs"::string) as monthly_energy_costs,
        TO_NUMBER(c.custom_attributes:"monthly fuel costs"::string) as monthly_fuel_costs,
        TO_NUMBER(c.custom_attributes:"Monthly Gas Cost"::string) as monthly_gas_cost,
        TO_NUMBER(c.custom_attributes:"Monthly Groceries Cost"::string) as monthly_groceries_cost,
        TO_NUMBER(c.custom_attributes:"Monthly Hobbies and Leisure Costs"::string) as monthly_hobbies_and_leisure_costs,
        TO_NUMBER(c.custom_attributes:"Monthly Internet and Subscription Costs"::string) as monthly_internet_and_subscription_costs,
        TO_NUMBER(c.custom_attributes:"Monthly Life Insurance Cost"::string) as monthly_life_insurance_cost,
        TO_NUMBER(c.custom_attributes:"Monthly Medical Costs"::string) as monthly_medical_costs,
        TO_NUMBER(c.custom_attributes:"Monthly Mortgage Amount"::string) as monthly_mortgage_amount,
        TO_NUMBER(c.custom_attributes:"Monthly Public Transport Costs"::string) as monthly_public_transport_costs,
        TO_NUMBER(c.custom_attributes:"Monthly Rent Amount"::string) as monthly_rent_amount,
        TO_NUMBER(c.custom_attributes:"Monthly TV Licence Cost"::string) as monthly_tv_licence_cost,
        TO_NUMBER(c.custom_attributes:"Monthly TV, Internet and Subscription costs"::string) as monthly_tv_internet_and_subscription_costs,
        TO_NUMBER(c.custom_attributes:"Monthly Vehicle Finance Costs"::string) as monthly_vehicle_finance_costs,
        TO_NUMBER(c.custom_attributes:"Monthly Vehicle Insurance Cost"::string) as monthly_vehicle_insurance_cost,
        TO_NUMBER(c.custom_attributes:"Monthly Vehicle Tax Cost"::string) as monthly_vehicle_tax_cost,
        TO_NUMBER(c.custom_attributes:"Monthly Water Cost"::string) as monthly_water_cost,
